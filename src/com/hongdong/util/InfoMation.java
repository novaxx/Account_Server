    ...
    public static String encryptBasedDes(String data) {  
        ...
        try {  
            ...
            cipher.init(Cipher.ENCRYPT_MODE, key, sr);  
                                 // 加密，并把字节数组编码成字符串  
            encryptedData = data;//new sun.misc.BASE64Encoder().encode(cipher.doFinal(data.getBytes()));  
        } catch (Exception e) {  
    ...
    public static String decryptBasedDes(String cryptData) {  
        ...
        try {  
            ...
            cipher.init(Cipher.DECRYPT_MODE, key, sr);  
                                // 把字符串解码为字节数组，并解密  
            decryptedData = cryptData;//new String(cipher.doFinal(new sun.misc.BASE64Decoder().decodeBuffer(cryptData)));  
        } catch (Exception e) {  
